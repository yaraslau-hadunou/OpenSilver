...
#region public Orientation Orientation
        ...
        /// </summary>
        /// <value>
        /// One of the <see cref="Controls.Orientation" />
        ...
        /// <summary>
        /// Identifies the
        /// <see cref="WrapPanel.Orientation" />
        /// dependency property.
        /// </summary>
        /// <value>
        /// The identifier for the
        ...
        private static void OnOrientationPropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
                ...
                (value != Orientation.Vertical))
            {
                ...
                string message = string.Format(
                    ...
                    OpenSilver.Internal.Controls.Toolkit.Resources.WrapPanel_OnOrientationPropertyChanged_InvalidValue,
                    value);
        ...
        private static void OnItemHeightOrWidthPropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (!value.IsNaN() && ((value <= 0.0) || double.IsPositiveInfinity(value)))
            {
                ...
                string message = string.Format(
                    CultureInfo.InvariantCulture,
                    OpenSilver.Internal.Controls.Toolkit.Resources.WrapPanel_OnItemHeightOrWidthPropertyChanged_InvalidValue,
                    value);
                throw new ArgumentException(message, "value");
            }
        ...
        /// <see cref="WrapPanel" /> in anticipation
        /// of arranging them during the
        /// <see cref="WrapPanel.ArrangeOverride(System.Windows.Size)" />
        /// pass.
        /// </summary>
        ...
        /// <see cref="WrapPanel" /> control and its
        /// child elements.
        /// </summary>
        /// <param name="finalSize">
        /// The area within the parent that the
        /// <see cref="WrapPanel" /> should use 
